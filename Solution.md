...
The Blog Page Application is a Django-based web application deployed on AWS Cloud infrastructure. The architecture includes an Application Load Balancer with an Auto Scaling Group of Amazon EC2 instances and an Amazon Relational Database Service (RDS) within a dedicated VPC. Amazon CloudFront and Route 53 are positioned in front of the architecture to securely manage incoming traffic. Users can upload images and videos to their blog pages, which are stored in an Amazon S3 bucket. The entire infrastructure is designed and implemented by the DevOps team.
...
- Copy the project files from the source repository into the capstone project folder on your local machine.
...
- Connect to your NAT instance:
  - In a new GitBash or MacOS Terminal: - change to the directory where your pem key file is
...
Domain : write your subdomain name and Check domain(example : `www.ogulcan-erdag.de`)!!!
Next
Specify origin
...
Select created cloudfront DNS : d2n5f6a9i8hvo8.cloudfront.net (your cloudfront DNS)!!!!
Routing policy                : Failover
Failover record type          : Primary
Health check ID               : aws-capstone-health-check
...
Enter S3 endpoint       : s3-website-us-east-1.amazonaws.com (your s3 bucket)
Routing policy                : Failover
Failover record type    : Secondary
Health check ID         : No health check
