...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/ogulcan/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/ogulcan/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.c2viygw8azkv.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'aws-capstones-ogulcan-blog' # please enter your s3 bucket name
